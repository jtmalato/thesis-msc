...
\draw  [dash pattern={on 4.5pt off 4.5pt}]  (430,120) -- (470,120) ;
\draw [shift={(470,120)}, rotate = 180] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ]   (0,0) .. controls (3.31,-0.67) and (6.95,-2.3) .. (10.93,-4.9)(0,0) .. controls (3.31,0.67) and (6.95,2.3) .. (10.93,4.9)   ;

\draw  [dash pattern={on 4.5pt off 4.5pt}]  (430,220) -- (470,220) ;
\draw [shift={(470,220)}, rotate = 180] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ]   (0,0) .. controls (3.31,-0.67) and (6.95,-2.3) .. (10.93,-4.9)(0,0) .. controls (3.31,0.67) and (6.95,2.3) .. (10.93,4.9)   ;
...
\draw (730,170) node   {$t$};
\draw (140,120) node  [align=left] {(a)};
\draw (450,190) node  [align=left] {$\uptau ^{*}$};
\draw (150,170) node  [align=left] {Birth};
\draw (140,220) node  [align=left] {(b)};
